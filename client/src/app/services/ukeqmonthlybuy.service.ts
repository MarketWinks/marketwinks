...
import { ukeqmonthlybuy } from './ukeqmonthlybuy.model';

@Injectable({
  providedIn: 'root'
})
export class UkeqMonthlybuyService {
  selectedMonthlybuy: ukeqmonthlybuy = {
  month: '',
  year: '',
  company: '',
	indicator: '',
  ...
  getMonthlybuyProfile() {
    return this.http.get(environment.apiBaseUrl + '/uK_LSE_MonthlyBuyProfile');
  }
