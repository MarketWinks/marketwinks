...
import { ukeqweeklysell } from './ukeqweeklysell.model';

@Injectable({
  providedIn: 'root'
})
export class UkeqWeeklysellService {
  selectedWeeklysell: ukeqweeklysell = {
  month: '',
  year: '',
  company: '',
	indicator: '',
  ...
  getWeeklysellProfile() {
    return this.http.get(environment.apiBaseUrl + '/uK_LSE_WeeklySellProfile');
  }
