...
import { useqhourlysell } from './useqhourlysell.model';

@Injectable({
  providedIn: 'root'
})
export class UseqHourlysellService {
  selectedHourlysell: useqhourlysell = {
  month: '',
  year: '',
  company: '',
	indicator: '',
  ...
  getHourlysellProfile() {
    return this.http.get(environment.apiBaseUrl + '/uS_HourlySellProfile');
  }
