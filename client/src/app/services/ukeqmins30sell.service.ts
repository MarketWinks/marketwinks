...
import { ukeqmins30sell } from './ukeqmins30sell.model';

@Injectable({
  providedIn: 'root'
})
export class UkeqMins30sellService {
  selectedMins30sell: ukeqmins30sell = {
  month: '',
  year: '',
  company: '',
	indicator: '',
  ...
  getMins30sellProfile() {
    return this.http.get(environment.apiBaseUrl + '/uK_LSE_30MinSellProfile');
  }
