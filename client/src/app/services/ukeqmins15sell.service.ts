...
import { ukeqmins15sell } from './ukeqmins15sell.model';

@Injectable({
  providedIn: 'root'
})
export class UkeqMins15sellService {
  selectedMins15sell: ukeqmins15sell = {
  month: '',
  year: '',
  company: '',
	indicator: '',
  ...
  getMins15sellProfile() {
    return this.http.get(environment.apiBaseUrl + '/uK_LSE_15MinSellProfile');
  }
