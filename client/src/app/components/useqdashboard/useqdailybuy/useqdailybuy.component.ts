...
import { UseqDailybuyService } from '../../../services/useqdailybuy.service';
...
@Component({
  selector: 'app-useqdailybuy',
  templateUrl: './useqdailybuy.component.html',
  styleUrls: ['./useqdailybuy.component.css']
})

export class UseqDailybuyComponent implements OnInit {
  //userDetails;
  dailybuyDetails;
  ...
  constructor(public dailybuyService: UseqDailybuyService, public router: Router, private EncrDecr: EncrDecrService) { }
