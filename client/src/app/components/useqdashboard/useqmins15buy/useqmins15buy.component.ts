...
import { UseqMins15buyService } from '../../../services/useqmins15buy.service';
...
@Component({
  ...
  templateUrl: './useqmins15buy.component.html',
  styleUrls: ['./useqmins15buy.component.css']
})

export class UseqMins15buyComponent implements OnInit {
  //userDetails;
  mins15buyDetails;
