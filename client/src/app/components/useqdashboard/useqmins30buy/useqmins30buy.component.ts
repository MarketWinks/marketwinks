...
import { UseqMins30buyService } from '../../../services/useqmins30buy.service';
...
@Component({
  selector: 'app-useqmins30buy',
  templateUrl: './useqmins30buy.component.html',
  styleUrls: ['./useqmins30buy.component.css']
})

export class UseqMins30buyComponent implements OnInit {
  //userDetails;
  mins30buyDetails;
  ...
  constructor(public mins30buyService: UseqMins30buyService, public router: Router, private EncrDecr: EncrDecrService) { }
