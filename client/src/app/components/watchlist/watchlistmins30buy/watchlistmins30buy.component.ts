...
@Component({
  selector: 'app-watchlistmins30buy',
  templateUrl: './watchlistmins30buy.component.html',
  styleUrls: ['./watchlistmins30buy.component.css']
})

export class Watchlist30MinsbuyComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.watchlistService.getWatchlistProfile(input).subscribe((data: any[]) => {
      ...
      this.watchlistService.getallsignalsfor30minsbuy(inputforallsignalsalltimes).subscribe(data => {
