...
import { Mins30sellService } from '../../../services/mins30sell.service';
...
@Component({
  selector: 'app-mins30sell',
  templateUrl: './mins30sell.component.html',
  styleUrls: ['./mins30sell.component.css']
})

export class Mins30sellComponent implements OnInit {
  //userDetails;
  mins30sellDetails;
  mins30sellDetailsUnique;
  mins30sellDetails_length;
  //constructor(public userService: UserService, public router: Router) { }
  constructor(public mins30sellService: Mins30sellService, public router: Router) { }
