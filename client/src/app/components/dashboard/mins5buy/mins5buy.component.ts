...
import { Mins5buyService } from '../../../services/mins5buy.service';
...
@Component({
  selector: 'app-mins5buy',
  templateUrl: './mins5buy.component.html',
  styleUrls: ['./mins5buy.component.css']
})

export class Mins5buyComponent implements OnInit {
  //userDetails;
  mins5buyDetails;
  ...
  constructor(public mins5buyService: Mins5buyService, public router: Router) { }
