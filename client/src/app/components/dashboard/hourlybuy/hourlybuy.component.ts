...
import { HourlybuyService } from '../../../services/hourlybuy.service';
...
@Component({
  selector: 'app-hourlybuy',
  templateUrl: './hourlybuy.component.html',
  styleUrls: ['./hourlybuy.component.css']
})

export class HourlybuyComponent implements OnInit {
  //userDetails;
  hourlybuyDetails;
  ...
  constructor(public hourlybuyService: HourlybuyService, public router: Router) { }
