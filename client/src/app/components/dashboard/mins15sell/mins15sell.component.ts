...
import { Mins15sellService } from '../../../services/mins15sell.service';
...
@Component({
  selector: 'app-mins15sell',
  templateUrl: './mins15sell.component.html',
  styleUrls: ['./mins15sell.component.css']
})

export class Mins15sellComponent implements OnInit {
  //userDetails;
  mins15sellDetails;
  mins15sellDetailsUnique;
  mins15sellDetails_length;
  //constructor(public userService: UserService, public router: Router) { }
  constructor(public mins15sellService: Mins15sellService, public router: Router) { }
