...
import { MonthlybuyService } from '../../../services/monthlybuy.service';
...
@Component({
  selector: 'app-monthlybuy',
  templateUrl: './monthlybuy.component.html',
  styleUrls: ['./monthlybuy.component.css']
})
...
export class MonthlybuyComponent implements OnInit {
  ...
  constructor(public monthlybuyService: MonthlybuyService, public router: Router) { }
