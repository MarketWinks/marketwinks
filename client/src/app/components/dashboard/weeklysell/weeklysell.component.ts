...
import { WeeklysellService } from '../../../services/weeklysell.service';
...
@Component({
  selector: 'app-weeklysell',
  templateUrl: './weeklysell.component.html',
  styleUrls: ['./weeklysell.component.css']
})

export class WeeklysellComponent implements OnInit {
  //userDetails;
  weeklysellDetails;
  weeklysellDetailsUnique;
  weeklysellDetails_length;
  //constructor(public userService: UserService, public router: Router) { }
  constructor(public weeklysellService: WeeklysellService, public router: Router) { }
