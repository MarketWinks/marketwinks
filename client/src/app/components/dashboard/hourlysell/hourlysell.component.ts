...
import { HourlysellService } from '../../../services/hourlysell.service';
...
@Component({
  selector: 'app-hourlysell',
  templateUrl: './hourlysell.component.html',
  styleUrls: ['./hourlysell.component.css']
})

export class HourlysellComponent implements OnInit {
  //userDetails;
  hourlysellDetails;
  hourlysellDetailsUnique;
  hourlysellDetails_length;
  //constructor(public userService: UserService, public router: Router) { }
  constructor(public hourlysellService: HourlysellService, public router: Router) { }
