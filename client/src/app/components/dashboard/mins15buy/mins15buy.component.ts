...
import { Mins15buyService } from '../../../services/mins15buy.service';
...
@Component({
  selector: 'app-mins15buy',
  templateUrl: './mins15buy.component.html',
  styleUrls: ['./mins15buy.component.css']
})

export class Mins15buyComponent implements OnInit {
  //userDetails;
  mins15buyDetails;
  ...
  constructor(public mins15buyService: Mins15buyService, public router: Router) { }
