...
@Component({
  selector: 'app-infopagedailybuy',
  templateUrl: './infopagedailybuy.component.html',
  styleUrls: ['./infopagedailybuy.component.css']
})

export class InfopageDailybuyComponent implements OnInit {
