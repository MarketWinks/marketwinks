...
import { UkeqMins30sellService } from '../../../services/ukeqmins30sell.service';
import { Router } from "@angular/router";
import { EncrDecrService } from 'src/app/services/encrdecr.service';

@Component({
  selector: 'app-ukeqmins30sell',
  templateUrl: './ukeqmins30sell.component.html',
  styleUrls: ['./ukeqmins30sell.component.css']
})


export class UkeqMins30sellComponent implements OnInit {

  mins30sellDetails: any;
  ...
  constructor(public mins30sellService: UkeqMins30sellService, public router: Router, private EncrDecr: EncrDecrService) { }
  ...
  ngOnInit() {
    ...
    this.mins30sellService.getMins30sellProfile().
      subscribe((res: any[]) => {
        ...
        this.mins30sellDetailsUnique = res;
        ...
        if (this.EncrDecr.get('123456$#@$^@1ERF', localStorage.getItem('_q1_')) == "TRIAL") {
          this.mins30sellDetails = this.mins30sellDetails.slice(0, 3);
  ...
  navigateToSignalInfoPage(mins30sellDetails_idparameter) {
    ...
    localStorage.setItem('mongoSignalrequestedTable', "uk_lse_30minsells");
    localStorage.setItem('mongoSignalrequestedSignalID', mins30sellDetails_idparameter);
  ...
  onclickbutton1() {
    this.block2 = true;
    this.button1 = false;
    if (this.mins30sellDetails.length > 100) {
      this.button2 = true;
    }
  ...
  onclickbutton2() {
    this.block3 = true;
    this.button2 = false;
    if (this.mins30sellDetails.length > 150) {
      this.button3 = true;
    }
  }
  ...
  onclickbutton3() {
    this.block4 = true;
    this.button3 = false;
    if (this.mins30sellDetails.length > 200) {
      this.button4 = true;
    }
  }
  ...
  onclickbutton4() {
    this.block5 = true;
    this.button4 = false;
    if (this.mins30sellDetails.length > 250) {
      this.button5 = true;
    }
  }
  onclickbutton5() {
    this.block6 = true;
    this.button5 = false;
    if (this.mins30sellDetails.length > 300) {
      this.button6 = true;
    }
  }
  onclickbutton6() {
    this.block7 = true;
    this.button6 = false;
    if (this.mins30sellDetails.length > 350) {
      this.button7 = true;
    }
  }
  onclickbutton7() {
    this.block8 = true;
    this.button7 = false;
    if (this.mins30sellDetails.length > 400) {
      this.button8 = true;
    }
  }
  onclickbutton8() {
